...
class VideoCardHLater extends StatelessWidget {
  ...
  final void Function(int cid, String coverHeroTag) onViewLater;
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                content(context, theme, coverHeroTag),
              ],
            ),
          ),
        ),
  ...
  Widget content(BuildContext context, ThemeData theme, Object heroTag) {
