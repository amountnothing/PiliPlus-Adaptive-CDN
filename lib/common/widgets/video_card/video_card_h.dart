...
class VideoCardH extends StatelessWidget {
  ...
  final ValueChanged<String>? onTapWithHero;
  final ValueChanged<int>? onViewLater;
  final VoidCallback? onRemove;
  String get coverHeroTag => PageUtils.videoCoverHeroTag(videoItem);
        ...
        children: [
          PageUtils.videoCardHero(
            ...
            child: InkWell(
              ...
              onTap: onTap != null || onTapWithHero != null
                  ? () {
                      if (onTapWithHero case final onTapWithHero?) {
                        onTapWithHero(coverHeroTag);
                      } else {
                        onTap!();
                      }
                    }
  ...
  Widget content(ThemeData theme, Object heroTag) {
    String pubdate = DateFormatUtils.dateFormat(videoItem.pubdate!);
    if (pubdate != '') pubdate += '  ';
    return Expanded(
      child: PageUtils.videoBodyHero(
        tag: heroTag,
        child: Column(
          crossAxisAlignment: .start,
          children: [
